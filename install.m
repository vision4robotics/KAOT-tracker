...
if exist('external_libs/mtimesx', 'dir') == 7
    ...
    error('KAOT:install', 'Mtimesx not found.')
end
...
if exist('external_libs/pdollar_toolbox/external', 'dir') == 7
    ...
    warning('KAOT:install', 'PDollars toolbox not found. Clone this submodule if you want to use HOG features. Skipping for now.')
end
...
if exist('external_libs/matconvnet/matlab', 'dir') == 7
    ...
    warning('KAOT:install', 'Matconvnet not found. Clone this submodule if you want to use CNN features. Skipping for now.')
end